...
from data_loader7 import SYSUData, RegDBData, TestData
from data_manager import *
from model_test7 import embed_net
from utils import *
import pdb
import scipy.io
...
parser.add_argument('--model_path', default='../save_model7/', type=str, help='model save path')
...
if dataset == 'sysu':
    ...
    model_path = checkpoint_path + 'regdb_adp_joint_co_nog_ch_nog_sq1_aug_G_erase_0.5_p4_n8_lr_0.1_seed_0_9_trial_{}_best.t'.format(test_trial)
    ...
    _, query_feat_fc = extract_query_feat(query_loader)
    _, gall_feat_fc = extract_gall_feat(gall_loader)

    print(len(query_feat_fc), len(gall_feat_fc))

    result = {'gallery_f':gall_feat_fc,'gallery_label':gall_label,'query_f':query_feat_fc,'query_label':query_label}
    scipy.io.savemat('tsne.mat',result)
