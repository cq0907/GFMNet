...
class SYSUData(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # img1_0 = torch.permute(img1_0, (1, 2, 0))
        # img1_1 = torch.permute(img1_1, (1, 2, 0))
        # img2 = torch.permute(img2, (1, 2, 0))
        #
        # img1_0 = self.embed_fn(img1_0)
        # img1_1 = self.embed_fn(img1_1)
        # img2 = self.embed_fn(img2)

        # img1_0 = torch.permute(img1_0, (2, 0, 1))
        # img1_1 = torch.permute(img1_1, (2, 0, 1))
