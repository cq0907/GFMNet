...
parser.add_argument('--model_path', default='save_model7/', type=str,
                    help='model save path')
parser.add_argument('--save_epoch', default=20, type=int,
                    metavar='s', help='save model every 10 epochs')
parser.add_argument('--log_path', default='log7/', type=str,
                    help='log save path')
...
if dataset == 'sysu':
    ...
    for trial in range(10):
        test_trial = trial + 1
        # model_path = checkpoint_path +  args.resume
        model_path = checkpoint_path + 'regdb_adp_joint_co_nog_ch_nog_sq1_aug_G_erase_0.5_p4_n8_lr_0.1_seed_0_9_trial_{}_best.t'.format(
            test_trial)
        if os.path.isfile(model_path):
